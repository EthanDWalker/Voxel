...
VkSemaphoreSubmitInfo SemaphoreSubmitInfo(VkPipelineStageFlags2 stage_mask, VkSemaphore semaphore, u32 value = 1);
...
VkImageCreateInfo ImageCI(VkFormat format, VkImageUsageFlags usage_flags, Vec3u32 extent, u32 mip_levels = 1);
